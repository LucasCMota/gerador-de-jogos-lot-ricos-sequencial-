(function(document){	
	...
	var $buttons = document.body.querySelectorAll( ".megasena" );
	...
	function lotteryGoodLuck( list ){
		...
		var n1 = 0, n2 = 1, n3 = 2, n4 = 3, n5 = 4, n6 = 5; 
		while( n >  0){
			switch( n > 0 ){
				case n6 < ( n ) :
						newArr.push( [list[n1], list[n2], list[n3], list[n4], list[n5], list[ n6 ]]) ;
						n6++
						break;
				case n5 < ( n ):
						n6 = 5;
